...
public class ListCollectionHelper {
	...
	public void deleteCollection(CollectionDetails toDelete) {
		EntityManager em = emfactory.createEntityManager();
		em.getTransaction().begin();
		TypedQuery<CollectionDetails> typedQuery = em.createQuery("select detail from CollectionDetails "
	...
	public CollectionDetails searchForCollectionDetailsById(Integer tempId) {
		EntityManager em = emfactory.createEntityManager();
		em.getTransaction().begin();
